import { articleByNumber, searchArticles } from "./articles-data.js";
export class InteractionController {
    ...
    openSearch(trigger) {
      ...
      <div class="modal-backdrop search-backdrop" data-close-overlay>
        ...
        input?.addEventListener("input", async () => {
            ...
            results.querySelectorAll("[data-search-article]").forEach((button) => {
    ...
    openSearchSummary(article, trigger) {
        this.lastFocused = trigger;
        this.overlayKind = "article";
        this.portal.innerHTML = `
      <div class="modal-backdrop article-backdrop" data-close-overlay>
